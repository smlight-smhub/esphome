...
void SmhubTime::setup() {
  global_smhub_time = this;
}
...
void SmhubTime::dump_config() {
  ESP_LOGCONFIG(TAG, "SMHUB Time:");
}

void SmhubTime::handle_time_response(uint64_t epoch_seconds) {
  this->synchronize_epoch_((uint32_t)epoch_seconds);
}
