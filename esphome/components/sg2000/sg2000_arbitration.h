...
#ifdef __cplusplus
inline void pad_config(uint32_t pin_reg_offset, bool pull_up, bool pull_down, uint8_t drive_strength, uint8_t schmitt = 0, bool slew_fast = false, bool bus_hold = false) {
