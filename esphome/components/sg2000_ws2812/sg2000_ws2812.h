...
class Sg2000Ws2812 : public light::AddressableLight {
 ...
 public:
  Sg2000Ws2812(uintptr_t spi_base, uint32_t num_leds) : spi_base_(spi_base), num_leds_(num_leds) {}
 ...
 protected:
  light::ESPColorView get_view_internal(int32_t index) const override {
    // WS2812 is GRB
    return {&buffer_[index * 3 + 1], &buffer_[index * 3 + 0], &buffer_[index * 3 + 2], nullptr,
            &effect_data_[index],    &this->correction_};
  }
};
